...
// Force underline redraw without full relayout
	   ...
	   var BOX_SHARED_LINK = "https://raw.githubusercontent.com/ShineTools1333/ShineTools/refs/heads/main/version.json";
        ...
        function _boxSharedToStatic(url) {
            try {
                ...
                if (url.indexOf("box.com") !== -1) url = convertBoxLink(url);
